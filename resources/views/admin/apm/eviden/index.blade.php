          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <form method="post" action="{{url('admin/apm/eviden')}}/{{$d->id}}" style="display:inline;">
                  @method('delete')
                  @csrf
...
<div id="tambah" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="{{url('admin/apm/eviden')}}" enctype="multipart/form-data">
...
<div id="importexcel" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="{{url('admin/apm/eviden/import')}}" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            x
          </button>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#tombol').on('click', function() {
      ...
      $('#tambah form').attr('action', `{{url('admin/apm/eviden')}}`);
      $('.patch').html('');
    ...
    $('.edit').on('click', function() {
      ...
      $('#tambah form').attr('action', `{{url('admin/apm/eviden/` + id + `')}}`);
