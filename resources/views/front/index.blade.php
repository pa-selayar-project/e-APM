		...
		<div class="row">
			<div class="col-md-12">
				<div class="card-box table-responsive">
					...
					<table id="lke1" class="display table table-stripped" style="width:100%">
						<thead>
							<tr>
									...
									<table class="table table-striped" width="100%">
										...
										<tr>
											...
											<td class="text-center" style="width:17%" valign="top">
												@if($e->file_upload)
													<a href=# class="text-danger download" data-id="{{$e->id}}" data-target="#lihat" data-toggle="modal" title="Upload"><i class="fa fa-file-pdf-o fa-lg"></i></a>
												@else
