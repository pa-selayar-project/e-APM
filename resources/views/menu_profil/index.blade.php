...
<ol class=" breadcrumb">
  ...
  <li>
    <a href="{{url('/menu_profil ')}}" class="active">Menu Profil</a>
  </li>
</ol>
@endsection
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="card-box table-responsive">
        <h4 class="m-t-0 header-title"><b>Daftar Menu Profil</b></h4>
          ...
          <tbody>
            ...
            <tr>
              <td colspan="6" height="300px">
                <h1 class="text-center m-t-40"> Tidak ada data !</h1>
              </td>
            </tr>
            @endif
            ...
            <tr>
              ...
              <td>
                ...
                <form action="menu_profil/{{$d->id}}" method="POST" style="display:inline;">
                  @method('delete')
                  @csrf
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModal">Tambah Menu Profil</h4>
      </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#tombol').on('click', function() {
        $('#tambah .modal-title').html('Tambah Menu Profil');
        $('#tambah form').attr('action', `{{url('menu_profil')}}`);
        $('.patch').html('');
      ...
      $('.edit').on('click', function() {
        const id = $(this).data('id'),
          ...
          link = $(this).data('link'),
          tipe = $(this).data('tipe');
        $('#tambah .modal-title').html('Rubah Menu Profil');
        $('#tambah form').attr('action', `{{url('/menu_profil/` + id + `')}}`);
